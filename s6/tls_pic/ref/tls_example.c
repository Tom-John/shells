...
// This C example is designed as more of a guide than a library to be 
...
// This will work with connections on port 587 that upgrade a plain 
// text session to an encrypted session with STARTTLS as covered here. 
